...
--
-- Host: 10.73.52.35    Database: WalDB
-- ------------------------------------------------------
...
--
-- Table structure for table `GQ_bins_chr1`
--

DROP TABLE IF EXISTS `GQ_bins_chr1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr1` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
  KEY `sample_idx` (`sample_id`)
) ENGINE=TokuDB DEFAULT CHARSET=latin1 ROW_FORMAT=TOKUDB_ZLIB;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `GQ_bins_chr10`
--

DROP TABLE IF EXISTS `GQ_bins_chr10`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr10` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr11`
--

DROP TABLE IF EXISTS `GQ_bins_chr11`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr11` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr12`
--

DROP TABLE IF EXISTS `GQ_bins_chr12`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr12` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr13`
--

DROP TABLE IF EXISTS `GQ_bins_chr13`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr13` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr14`
--

DROP TABLE IF EXISTS `GQ_bins_chr14`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr14` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr15`
--

DROP TABLE IF EXISTS `GQ_bins_chr15`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr15` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr16`
--

DROP TABLE IF EXISTS `GQ_bins_chr16`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr16` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr17`
--

DROP TABLE IF EXISTS `GQ_bins_chr17`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr17` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr18`
--

DROP TABLE IF EXISTS `GQ_bins_chr18`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr18` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr19`
--

DROP TABLE IF EXISTS `GQ_bins_chr19`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr19` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr2`
--

DROP TABLE IF EXISTS `GQ_bins_chr2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr2` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr20`
--

DROP TABLE IF EXISTS `GQ_bins_chr20`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr20` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr21`
--

DROP TABLE IF EXISTS `GQ_bins_chr21`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr21` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr22`
--

DROP TABLE IF EXISTS `GQ_bins_chr22`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr22` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr3`
--

DROP TABLE IF EXISTS `GQ_bins_chr3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr3` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr4`
--

DROP TABLE IF EXISTS `GQ_bins_chr4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr4` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr5`
--

DROP TABLE IF EXISTS `GQ_bins_chr5`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr5` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr6`
--

DROP TABLE IF EXISTS `GQ_bins_chr6`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr6` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr7`
--

DROP TABLE IF EXISTS `GQ_bins_chr7`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr7` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr8`
--

DROP TABLE IF EXISTS `GQ_bins_chr8`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr8` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chr9`
--

DROP TABLE IF EXISTS `GQ_bins_chr9`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chr9` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chrMT`
--

DROP TABLE IF EXISTS `GQ_bins_chrMT`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chrMT` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chrX`
--

DROP TABLE IF EXISTS `GQ_bins_chrX`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chrX` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
--
-- Table structure for table `GQ_bins_chrY`
--

DROP TABLE IF EXISTS `GQ_bins_chrY`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GQ_bins_chrY` (
  `sample_id` mediumint(8) unsigned NOT NULL,
  `block_id` smallint(5) unsigned NOT NULL,
  `GQ_string` varchar(20000) DEFAULT NULL,
  PRIMARY KEY (`block_id`,`sample_id`),
...
CREATE TABLE `called_variant_chr1` (
  ...
  `PID_variant_id` mediumint(8) unsigned DEFAULT NULL,
  `PGT` tinyint(3) unsigned DEFAULT NULL,
  `HP_variant_id` mediumint(8) unsigned DEFAULT NULL,
  ...
  UNIQUE KEY `sample_variant_idx` (`sample_id`,`variant_id`),
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hgnc` (
  `gene_id` mediumint(9) NOT NULL,
  `chrom` varchar(2) NOT NULL,
  `start` int(10) unsigned NOT NULL,
  `end` int(10) unsigned NOT NULL,
  `gene` varchar(50) NOT NULL,
  PRIMARY KEY (`gene`),
  KEY `chrom_idx` (`chrom`,`gene_id`),
...
CREATE TABLE `sample` (
  ...
  `sample_type` enum('genome','exome','custom_capture','merged') NOT NULL,
  `capture_kit` varchar(20) NOT NULL DEFAULT '',
  `prep_id` mediumint(8) unsigned DEFAULT NULL,
  ...
  UNIQUE KEY `sample_idx` (`sample_name`,`sample_type`,`capture_kit`),
  KEY `prep_idx` (`prep_id`),
  KEY `initialization_idx` (`sample_finished`,`initialization_time`)
) ENGINE=TokuDB DEFAULT CHARSET=latin1 ROW_FORMAT=TOKUDB_ZLIB;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `variant_chr15` (
  ...
  PRIMARY KEY (`POS`,`variant_id`,`effect_id`,`transcript_stable_id`),
  KEY `gene_idx` (`gene`),
  KEY `variant_idx` (`variant_id`,`POS`,`REF`,`ALT`),
  KEY `effect_idx` (`effect_id`),
  KEY `variant_exists_idx` (`POS`,`indel_length`,`REF`,`ALT`,`variant_id`,`effect_id`,`has_high_quality_call`),
  KEY `has_high_quality_call_idx` (`has_high_quality_call`)
) ENGINE=TokuDB DEFAULT CHARSET=latin1 ROW_FORMAT=TOKUDB_ZLIB;
...
-- Dump completed on 2017-01-05 14:26:45
