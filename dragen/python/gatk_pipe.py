...
class UpdateSeqdbMetrics(GATKFPipelineTask):
    ...
    def pre_shell_commands(self):
        ...
        if self.sample_type == "GENOME_AS_FAKE_EXOME":
            if not os.path.exists("/nfs/informatics/data/pipeline/dragen_pipe/logs/postmerge/{}.{}.txt".format(self.pseudo_prepid,self.sample_name)):
                hack_for_incorrect_single_rg_wgs="/nfs/goldstein/software/informatics/bin/alignstats -q 10 -i /nfs/seqscratch_ssd/ALIGNMENT/BUILD37/DRAGEN/GENOME_AS_FAKE_EXOME/{1}.{0}/{1}.{0}.bam \
                    -t /nfs/seqscratch_ssd/PIPELINE_DATA/ccds_regions.bed  -o /nfs/informatics/data/pipeline/dragen_pipe/logs/postmerge/{0}.{1}.txt".format(self.pseudo_prepid,self.sample_name)
        ...
        if self.sample_type == "GENOME_AS_FAKE_EXOME":
            ...
            gvcf_lazy=""
            metrics_lazy="/nfs/informatics/data/pipeline/dragen_pipe/logs/postmerge/{}.{}.txt".format(self.pseudo_prepid,self.sample_name)
